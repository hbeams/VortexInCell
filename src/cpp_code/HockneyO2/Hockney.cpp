...
void Hockney::convolve(RectMDArray<double>& a_rhs)
{
    ...
    outputStreamRHSDouble.open("RHSDouble.txt", ofstream::app);
    ...
    outputStreamRHSDoubleFFT.open("RHSDoubleFFT.txt", ofstream::app);
    ...
    outputStreamKernel.open("Kernel.txt", ofstream::app);
    ...
    outputStreamSoln.open("soln.txt", ofstream::app);
